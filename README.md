...
- Built and maintained features for a technology-driven service marketplace.
- Worked with **Node.js**, **React**, and **Next.js**.
- Optimized application performance using **Redis**.
